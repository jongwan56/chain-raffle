...
const ParticipatePage: NextPage = () => {
  ...
  const participate = async () => {
    ...
    const tx = await contractInstance.addParticipantToEvent.populateTransaction(
      eventName,
      participantName,
    );
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center">
      <div className="bg-white rounded p-8 w-96">
        <h2 className="text-3xl font-bold mb-4 text-black">Participate</h2>
        ...
        <div className="flex flex-col mt-2">
          <p className="text-xs text-neutral-500">My Name</p>
          <input
            className="mt-1 mb-2 px-3 border rounded-md text-black w-full h-10"
            type="text"
        ...
        <div className="flex justify-center mt-4">
          <button
            ...
            disabled={isLoading || !eventName || !participantName}
            onClick={participate}
          >
            Submit
          </button>
